...
|---|--------|---------------|-------------------|-----------|---------------|--------------|----------------|
| 1 | PASS | 40 | 256 | 2778.6 | 14.4 | 5.5 | 49.47 |

## 3 Sequential Requests

| # | Status | Prompt Tokens | Completion Tokens | TTFT (ms) | Prefill tok/s | Decode tok/s | Total Time (s) |
|---|--------|---------------|-------------------|-----------|---------------|--------------|----------------|
| 1 | PASS | 38 | 256 | 2583.7 | 14.7 | 5.2 | 51.79 |
| 2 | FAIL `TimeoutError: timed out` | 0 | 0 | 0.0 | 0.0 | 0.0 | 306.98 |
...
- **Failed:** 2
- **Avg TTFT:** 2681.2 ms
- **Avg prefill tok/s:** 14.6
- **Avg decode tok/s:** 5.3
- **Total output tokens:** 512
- **Avg per-request throughput:** 5.1 tok/s
